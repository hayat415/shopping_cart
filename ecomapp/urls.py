...
urlpatterns = [
    ...
    path("register/",CustomerRegistratonView.as_view(),name="customerregistration"),
    path("logout/", CustomerLogoutView.as_view(), name="cutomerlogout"),
    ...
    path("easypaisa-request/", EasypaisaRequestView.as_view(), name="easypaisarequest"),
]
